...
You can click [this link](https://www.google.com) in order to get more information for each batch.
#
...
* 32-week full program
* 200+ hours of video lessons
* 20+ real-world projects
* Homework assignments for each weekend
* Practical exercises for each lesson
* Peer study groups
* LinkedIn profile review 
* Pay as you go (monthly)
* 1-on-1 Code Review Centric approach
* AWS Machine Learning Speciality exam preperation
* Theory needed to develop your skills
...
About half of that time will be spent attending classes on 1, 3 and 5th days of the week (19:00 - 21:00), and the rest will be spent working on assignments & projects during the weekend. Weekly assignments will test your skills.
...
# 
You can checkout syllabus for each batch on its own page.
