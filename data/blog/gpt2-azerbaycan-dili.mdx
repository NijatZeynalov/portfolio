...
Bu model GPT ailəsinin Azərbaycan dilinə tətbiqi üçün araşdırma məqsədi ilə hazırlanmışdır. Mövcud resurslarım əlverişli olmadığı üçün, bu modelə yenidən qayıdacağam, nəticələri daha da yaxşılaşdırmaq üçün planlaşdırıram:
