...
5. "gpt2-azerbaijani-small modeli"-nin train olunması və performansı
...
Bu model GPT-2 modelinin Azərbaycan dilinə tətbiqi üçün araşdırma məqsədi ilə hazırlanmışdır və hazirki versiyadan kommersial layihələrdə istifadəsi tövsiyə edilmir.

Mövcud resurslarım əlverişli olmadığı üçün, bu modelə yenidən qayıdacağam, nəticələri daha da yaxşılaşdırmaq üçün planlaşdırıram:

* Azərbaycan dilində daha çox train data əlavə etmək (Ümumilikdə müxtəlif resurslardan istifadə edərək, 500k+ məqalə tapıb əlavə etmək mümükündür.)
* Daha güclü GPU istifadə edərək fərqli eksperimentlər aparmaq
* Epoch sayını artırmaq (Hazırki GPU ilə 1 epoch təqribən ~9 saat davam edir ($0.90/hr). Layihənin məqsədini və digər resursları nəzərə alıb, 3 epochda dayandırmağı məqbul görmüşəm.)
