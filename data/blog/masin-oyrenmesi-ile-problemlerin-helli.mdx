...
Aşağıdakı şəkildə bütün maraqlı tərəflərin ehtiyaclarına uyğun modelləşdirmə işlərinin aparılması üçün lazımlı nüanslar qeyd olunub. __Əla model sadəcə əla nəticəsi olan model deyil, maraqlı tərəflərin də əla olduğunu təsdiq edə biləcəyi bir modeldir.__
...
* Xərc: Xərci mütləq şəkildə öncədən düşünməlisiniz, modeli işə salmaq üçün istifadə etdiyiniz infrastrukturun dəyəri çox yüksək ola bilər. Məsələn, mənim [səslə](https://github.com/NijatZeynalov/sesle-tts) adlı layihəm var - bu layihəni mən Google cloud üzərində deploy etmişdim və günlük xərcim ~45 dollara yaxın idi. Hansı ki, öncədən bunu gözləmədiyim üçün layihəni productiondan çıxarmalı oldum.
