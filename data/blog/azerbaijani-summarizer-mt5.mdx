---
title: 'mT5-small based Azerbaijani Summarization'
date: '2022-12-30'
tags: []
draft: false
summary: 'In this project, Google's Multilingual T5-small is fine-tuned on Azerbaijani News Summary Dataset for Summarization downstream task.'
images: ['/static/blogs/mt5-azerbaijani-summarize/mt5-summarize.png']
authors: ['default']
---
...
mT5 is a multilingual variant of  **T5**  and only pre-trained on  [mC4](https://www.tensorflow.org/datasets/catalog/c4#c4multilingual)  excluding any supervised training. Therefore, the mT5 model has to be fine-tuned before it is useable on a downstream task.

### [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#text-to-text-transfer-transformer-t5)Text-to-Text Transfer Transformer (T5)
...
[![Alt Text](https://miro.medium.com/max/1280/0*xfXDPjASztwmJlOa.gif)](https://miro.medium.com/max/1280/0*xfXDPjASztwmJlOa.gif)
...
### [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#multilingual-t5)Multilingual t5

["mt5"](https://arxiv.org/pdf/2010.11934v3.pdf)  is a multilingual variant of T5 that was pre-trained on a new Common Crawl-based dataset covering 101 languages.
...
## [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#training-hyperparameters)Training hyperparameters

**mT5-based-azerbaijani-summarize**  model training took almost 12 hours on GPU instance with Ubuntu Server 20.04 LTS image in Microsoft Azure. The following hyperparameters were used during training:
...
## [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#dataset)Dataset

Model was trained on  [**az-news-summary**  dataset](https://huggingface.co/datasets/nijatzeynalov/azerbaijani-multi-news), a comprehensive and diverse dataset comprising 143k (143,448) Azerbaijani news articles extracted using a set of carefully designed heuristics.
...
## [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#training-results-with-comparison)Training results with comparison

**mT5-based-azerbaijani-summarize**  model rouge scores on the test set:

-   Rouge1: 39.4222
-   Rouge2: 24.8624
-   Rougel: 32.2487

For  **Azerbaijani text summarization downstream task**, mT5-multilingual-XLSum has also been developed on the 45 languages of  [XL-Sum](https://huggingface.co/datasets/csebuetnlp/xlsum)  dataset. For finetuning details and scripts, see the  [paper](https://aclanthology.org/2021.findings-acl.413/)  and the  [official repository](https://github.com/csebuetnlp/xl-sum). .

**mT5_multilingual_XLSum**  modelrouge scores on the XL-Sum test set (only for Azerbaijani):

-   Rouge1: 21.4227
-   Rouge2: 9.5214
-   Rougel: 19.3331

As seen from the numbers, our model  **mT5-based-azerbaijani-summarize**  achieves dramatically better performance than  **mT5_multilingual_XLSum**.

## [](https://huggingface.co/nijatzeynalov/mT5-based-azerbaijani-summarize#using-this-model-in-transformers)Using this model in transformers
